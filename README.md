...
Bu çalışmada  NYC Taxi veri seti incelendi.
Amaç:
...
Veri seti RAM’e tamamen alınmadan DuckDB ile incelendi.
...
* Sayısal kolonlar için min / max / median değerler incelendi
* Veri dağılımı ve uç değerler gözlemlendi

---

## Eksik Veri Analizi

Eksik veri oranları incelendi.
...
Veri setinde aşağıdaki anomali durumları tespit edildi:
...
* Negatif veya hatalı süre hesapları
 ...
 Bu değerler veri kalitesini bozabilecek açık aykırılıklar olarak değerlendirildi.
...
Ana senaryo olarak **Order Count** seçildi çünkü operasyonel planlama açısından doğrudan aksiyona dönüştürülebilir bir çıktıdır (sürücü sayısı planlama).

Alternatif olarak **Average Fare** senaryosu değerlendirildi. Bu senaryo fiyat trendlerini anlamak ve stratejik karar destek sağlamak için uygundur.
